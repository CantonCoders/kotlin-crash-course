...
class FizzBuzzTest {
    ...
    @Test
    fun `Input of 100 should return "buzz"`() {
    ...
    @Test
    fun `String containing the digit 3 should return "fizz"`() {
        val result = fizzBuzz.go(31)
        assertEquals("fizz", result)
    }

    @Test
    fun `Input of 52 should return "buzz"`() {
        val result = fizzBuzz.go(52)
        assertEquals("buzz", result)
    }

    @Test
    fun `Input of 53 should return "fizzbuzz"`() {
        val result = fizzBuzz.go(53)
        assertEquals("fizzbuzz", result)
    }
}